...
describe('Testing TypeZeroTx', () => {
		...
		describe('when providing all the needed parameters', () => {
			describe('when providing the parameters in a wrong format', () => {
				it('should throw when giving nonce as a string', () => {
					...
					}).to.throw("'nonce' should be a number or a hex string starting with '0x'");
				});
				it('should throw when giving value as a string', () => {
					...
					expect(() => {
						generateTypeZeroTxJSONFromParams(nonce, gasPrice, gasLimit, value, data);
					}).to.throw("'value' should be a number or a hex string starting with '0x'");
				});
				...
				it('should throw when giving gasPrice as a bool', () => {
					...
					expect(() => {
						generateTypeZeroTxJSONFromParams(nonce, gasPrice, gasLimit, value, data);
					}).to.throw("'gasPrice' should be a number or a hex string starting with '0x'");
				});
				it('should throw when giving gasLimit as an array', () => {
					...
					expect(() => {
						generateTypeZeroTxJSONFromParams(nonce, gasPrice, gasLimit, value, data);
					}).to.throw("'gasLimit' should be a number or a hex string starting with '0x'");
				});
			});
			describe('when providing the parameters in a correct format', () => {
				it('should pass when giving nonce, gasPrice, gasLimit, value and data and expect to have all properties given and convert them to hex', () => {
					...
					expect(txParams).to.have.property('gasPrice', `0x${gasPrice.toString(16)}`);
					expect(txParams).to.have.property('gasLimit', `0x${gasLimit.toString(16)}`);
		...
		describe('when providing optional parameters', () => {
			describe('when providing the parameters in a wrong format', () => {
				it('should throw when giving to field as a bytes4 string', () => {
					...
					expect(() => {
						generateTypeZeroTxJSONFromParams(nonce, gasPrice, gasLimit, value, data, { to: 'aabbccdd' });
					}).to.throw(
				...
				it('should throw when giving to field as a number', () => {
					...
					expect(() => {
						generateTypeZeroTxJSONFromParams(nonce, gasPrice, gasLimit, value, data, { to: 288 });
					}).to.throw(
						"'to' should be a valid Ethereum address (hex string starting with '0x' and 42 characters long)",
					);
				});
			...
			describe('when providing the parameters in a correct format', () => {
				describe('when providing v value as number', () => {
					it('should pass and return it as a hex', () => {
						...
						const data = '0xaabbccdd';
						const v = 27;
						const r = '0x1212121212121212121212121212121212121212121212121212121212121212';
						const s = '0x1212121212121212121212121212121212121212121212121212121212121212';
			...
			describe('when providing not the full signature value', () => {
				describe('when not providing the v param', () => {
					it('should throw', () => {
						...
						expect(() => {
							generateTypeZeroTxJSONFromParams(nonce, gasPrice, gasLimit, value, data, { to, s, r });
						}).to.throw(
				...
				describe('when not providing the r param', () => {
					it('should throw', () => {
						...
						expect(() => {
							generateTypeZeroTxJSONFromParams(nonce, gasPrice, gasLimit, value, data, { to, v, s });
						}).to.throw(
							"'v', 'r', and 's' should all be provided together or none of them should be provided.",
						);
					});
				...
				describe('when not providing the s param', () => {
					it('should throw', () => {
						...
						expect(() => {
							generateTypeZeroTxJSONFromParams(nonce, gasPrice, gasLimit, value, data, { to, v, r });
						}).to.throw(
							"'v', 'r', and 's' should all be provided together or none of them should be provided.",
						);
					});
	...
	describe('generateNickMethodConfigForContractDeployment', () => {
		...
		describe('when not providing all the needed parameters', () => {
			describe('when not providing the gasPrice', () => {
				it('should throw', () => {
					...
					}).to.throw('txParams must include gasLimit, gasPrice, and data properties');
				});
			});
		...
		describe('when providing the parameters in the wrong format', () => {
			describe('when providing the gasPrice in a wrong format', () => {
				it('should throw', () => {
					...
					expect(() => {
						generateNickMethodConfigForContractDeployment(txParams);
					}).to.throw('The gasPrice parameter must be a hexadecimal string or a number');
				});
			});
			describe('when providing the gasLimit in a wrong format', () => {
				it('should throw', () => {
					...
					expect(() => {
						generateNickMethodConfigForContractDeployment(txParams);
					}).to.throw('The gasLimit parameter must be a hexadecimal string or a number');
				});
			});
			...
			describe('when providing the value in a wrong format', () => {
				it('should throw', () => {
					...
					expect(() => {
						generateNickMethodConfigForContractDeployment(txParams);
					}).to.throw('The value parameter must be a hexadecimal string or a number');
				});
			});
		...
		describe('when providing the parameters in number should convert to hex', () => {
			...
			const nickMethodConfig = generateNickMethodConfigForContractDeployment(txParams);

			expect(nickMethodConfig).to.have.property('gasPrice', `${txParams.gasPrice.toString(16)}`);
			expect(nickMethodConfig).to.have.property('gasLimit', `${txParams.gasLimit.toString(16)}`);
		});
		describe('when providing all the needed parameters', () => {
		...
		describe('when providing the chainId as optional parameters', () => {
			it('should return a v value corresponding to the chainId', () => {
				...
				const nickMethodConfig = generateNickMethodConfigForContractDeployment(txParams, opt);
	...
	describe.only('test', () => {
		it('tets', () => {
			let txParams = {
				...
				gasLimit: 1000000,
				data: '',
			};
